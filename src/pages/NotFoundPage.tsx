...
const NotFoundPage: React.FC = () => {
  ...
  return (
    <section className="flex min-h-screen w-full items-center justify-center px-6 py-16">
      <div
        className={`mx-auto w-full max-w-lg space-y-8 rounded-[36px] bg-white/80 p-10 text-center shadow-[0_35px_120px_rgba(248,180,196,0.35)] ring-1 ring-white/60 backdrop-blur-2xl transition-all duration-400 ease-out ${
