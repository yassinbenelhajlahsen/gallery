      ...
      <div className="mx-auto flex flex-col items-center justify-center gap-1.5 px-4 py-4 text-xs text-[#aaa]">
        ...
        <div>
          <button
            ...
            className="mt-1 rounded-full px-2.5 py-1.5 sm:px-4 leading-tight text-[#999] transition-all duration-150 hover:bg-[#FFE9F1] hover:text-[#555] active:scale-95 touch-manipulation"
            aria-label="Sign out"
          >
            Logout
          </button>
